...
const Story = () => {
  return (
    <section id="ourstory" className="relative py-8 md:py-12 px-4 md:px-16 overflow-hidden min-h-[30vh] lg:min-h-[90vh]">
      ...
      <h1 className="absolute left-4 md:left-16 top-0 text-[12vw] md:text-[8vw] lg:text-[11vw] font-bold text-purple-200 opacity-40 select-none pointer-events-none z-0 whitespace-nowrap font-montserrat">
        Our Story
      </h1>
      ...
      <img
        ...
        className="absolute -top-10 md:top-10 right-0 w-full max-w-[200px] md:max-w-[450px] lg:max-w-[45%] h-[100%] object-contain md:z-30 pointer-events-none"
        style={{
      ...
      <div className="relative z-20 pt-8 md:pt-12 lg:pt-36">
        <div className="flex flex-col lg:flex-row items-start gap-8 lg:gap-12">
          ...
          <div className="flex-1 max-w-xl">
            <div className="flex items-center mb-10 md:mb-16">
              ...
              <h2 className="text-3xl md:text-4xl lg:text-7xl font-bold text-black font-montserrat">
                Our Story
              </h2>
            </div>
            
            <div className="space-y-4">
              <h3 className="text-[#580F54] font-semibold text-lg md:text-xl lg:text-2xl font-inter">
